...
export enum ColumnBW {
  ...
  UPDATE = 6,
  SEARCH = 7,
  READONLY_ON_UPDATE = 8,
  READONLY_ON_CREATE = 9,
  COLUMN_ORDER = 10,
  GROUP_ORDER = 11,
  IS_LABEL = 12,
  TABLE_LABEL = 13,
...
export enum InputWidget{
  ENUM='m-dropdown',
  FOREIGN='m-dropdown',
  DECIMAL2='m-input-number',
  DECIMAL4='m-input-number',
  DECIMAL0='m-input-number',
  DATE='m-calendar',
  TIME='m-time',
  BOOLEAN='m-switch',
  SHOT_TEXT='m-input-text',
  LONG_TEXT='m-input-text-area',
  EMAIL='m-input-text',
  PHONE='m-input-text',
}
export enum SearchOptionDataType{
  ENUM='ENUM',
  FOREIGN='ENUM',
  DECIMAL2='DECIMAL',
  DECIMAL4='DECIMAL',
